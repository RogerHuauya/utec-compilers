...
#line 52 "grammar.y"
    {
                                 (yyval.exp) = new Plus ((yyvsp[(1) - (3)].exp), (yyvsp[(3) - (3)].exp));
  ...
  case 6:
#line 58 "grammar.y"
    { (yyval.exp) = new Number ((yyvsp[(1) - (1)].value)); nodes.push ((yyval.exp)); ;}
    break;
